...
# prepare the dialog and streaming to the piprline
...
# precompute the tokens for system prompt and memory for the large model
...
def streaming_dialogue(dialogue, mem = ""):
    ...
    for i, curr_word in enumerate(words):
        ...
        # tokenize and encode the streaming input word
        ...
        # only allow the model to respond at |SILENCE > token
        ...
        if i >= 1:
            ...
            ## triggered the large model to generate response
            if If_Generate:
